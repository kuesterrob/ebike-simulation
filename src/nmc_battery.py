...
class NMCBatteryPack(BatteryPack):
    """NMC-Akkupack mit eigener OCV-Kennlinie."""
    ...
    def voltage(
        ...
        """Berechnet die NMC-Spannung unter Last."""

        # NMC-Open-Circuit-Spannung:
        # U_OCV =  U_min + SoC^0,834 * (U_max - U_min)
        ...
        # Spannung unter Last: U_Last = U_OCV - I * R(T)
        return (
            open_circuit_voltage
